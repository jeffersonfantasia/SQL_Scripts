WITH LANC_PCLANC AS
 (SELECT DISTINCT L.NUMNOTA, L.CODFORNEC, MIN(L.CODCONTA) AS CODCONTA
    FROM PCLANC L LEFT JOIN PCCONTA C ON L.CODCONTA= C.CODCONTA
...
--NAO TRAZER NOTAS CANCELADAS
 ...
 SELECT * FROM PCLANC L WHERE L.NUMNOTA = 139850;

...
/****************TABELAS DE BACKUP********************/
--PCNFENT
CREATE TABLE BKP_PCNFENT_PARCIAL_02_09_2024 AS 
   SELECT E.* FROM PCNFENT E WHERE E.NUMTRANSVENDAORIG IN (22137941);

--PCMOV
CREATE TABLE BKP_PCMOV_PARCIAL_02_09_2024 AS
  WITH NUMTRANSENT_NOTAS AS
 (SELECT E.NUMTRANSENT
    FROM PCNFENT E
   WHERE E.NUMTRANSVENDAORIG IN (22137941)) 
  SELECT M.*
    FROM PCMOV M
...
--PCMOVCOMPLE
CREATE TABLE BKP_PCMOVCOMPLE_PARCIAL_02_09_2024 AS 
  WITH NUMTRANSENT_NOTAS AS
  (SELECT E.NUMTRANSENT,
         E.DTENT,
         E.DTSELOFISCAL
...
--PCNFENT 
UPDATE PCNFENT
   SET DTENT        = TO_DATE('31/08/2024', 'DD/MM/YYYY'),
       DTSELOFISCAL = TO_DATE('31/08/2024', 'DD/MM/YYYY')
 WHERE NUMTRANSVENDAORIG IN (22137941);

--PCMOV 
UPDATE PCMOV
   SET DTMOV       = TO_DATE('31/08/2024', 'DD/MM/YYYY'),
       DTMOVLOG    = TO_DATE('31/08/2024', 'DD/MM/YYYY'),
       DATAESTOQUE = TO_DATE('31/08/2024', 'DD/MM/YYYY')
...
--PCMOVCOMPLE
UPDATE PCMOVCOMPLE
   SET DTREGISTRO = TO_DATE('31/08/2024', 'DD/MM/YYYY')
...
SELECT * FROM DTREGISTRO_PRODUTOS;

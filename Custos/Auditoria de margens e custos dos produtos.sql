...
SELECT *
 ...
 WHERE MIDEAL <> MPRECO
    ...
    OR (NCM = '49019900.' AND MIDEAL <> 38.72)
    OR (NCM <> '49019900.' AND NUMREGIAO = 1 AND MIDEAL <> 31.47)
    OR (NCM <> '49019900.' AND IMPORTADO = 'N' AND NUMREGIAO = 3 AND MIDEAL <> 35.70)
    OR (NCM <> '49019900.' AND IMPORTADO = 'N' AND NUMREGIAO = 4 AND MIDEAL <> 33.78)
    OR (NCM <> '49019900.' AND IMPORTADO = 'S' AND NUMREGIAO IN (3, 4) AND MIDEAL <> 36.85)

    ...
    SELECT P.CODFILIAL,
     ...
     WHERE P.CODFILIAL = '2'
       ...
       AND E.CODFORNECPRINC = 2
			 AND P.CODPROD NOT IN (817282,817280,817290,817285,817287,817286,811395,811396,811397)
     ORDER BY P.CODPROD,
              P.NUMREGIAO
)
 WHERE MIDEAL <> MPRECO
    ...
    OR ((DESCRICAO LIKE '%LIVRO%' OR DESCRICAO LIKE '%LIVRINHO%') AND MIDEAL <> 35.39)
    OR ((DESCRICAO NOT LIKE '%LIVRO%' OR DESCRICAO NOT LIKE '%LIVRINHO%') AND NUMREGIAO = 1 AND MIDEAL <> 32.07)
    OR ((DESCRICAO NOT LIKE '%LIVRO%' OR DESCRICAO NOT LIKE '%LIVRINHO%') AND IMPORTADO = 'N' AND NUMREGIAO = 3 AND MIDEAL <> 36.37)
    OR ((DESCRICAO NOT LIKE '%LIVRO%' OR DESCRICAO NOT LIKE '%LIVRINHO%') AND IMPORTADO = 'N' AND NUMREGIAO = 4 AND MIDEAL <> 34.41)
    OR ((DESCRICAO NOT LIKE '%LIVRO%' OR DESCRICAO NOT LIKE '%LIVRINHO%')AND IMPORTADO = 'S' AND NUMREGIAO IN (3, 4) AND MIDEAL <> 37.54)

...
SELECT *
 ...
 WHERE MIDEAL <> MPRECO
    ...
    OR (DESCRICAO NOT LIKE '%LIVRO%' AND NUMREGIAO = 1 AND MIDEAL <> 32.07)
    OR (DESCRICAO NOT LIKE '%LIVRO%' AND IMPORTADO = 'N' AND NUMREGIAO = 3 AND MIDEAL <> 36.37)
    OR (DESCRICAO NOT LIKE '%LIVRO%' AND IMPORTADO = 'N' AND NUMREGIAO = 4 AND MIDEAL <> 34.41)
    OR (DESCRICAO NOT LIKE '%LIVRO%' AND IMPORTADO = 'S' AND NUMREGIAO IN (3, 4) AND MIDEAL <> 37.54);
/
...
SELECT *
 ...
 WHERE MIDEAL <> MPRECO
    ...
    OR (NCM <> '49019900.' AND NUMREGIAO = 1 AND MIDEAL <> 32.07)
    OR (NCM <> '49019900.' AND IMPORTADO = 'N' AND NUMREGIAO = 3 AND MIDEAL <> 36.37)
    OR (NCM <> '49019900.' AND IMPORTADO = 'N' AND NUMREGIAO = 4 AND MIDEAL <> 34.41)
    OR (NCM <> '49019900.' AND IMPORTADO = 'S' AND NUMREGIAO IN (3, 4) AND MIDEAL <> 37.54)

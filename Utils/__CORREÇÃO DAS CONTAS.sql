...
SELECT E.DTLANCTO,
  ...
  FROM PCNFENT E
 WHERE 1 = 1
   --AND NUMTRANSENT IN (1822705, 1822719, 1822708, 1822720) 
   AND NUMNOTA IN (19323, 5386) --10658
--AND CODFORNEC = 10516    
...
SELECT L.NOMEFUNC,
 ...
 WHERE 1 = 1
   AND L.NUMNOTA IN (4293560, 96966, 7987, 62146)
      AND (CODFORNEC IN (10645, 10682, 10525, 10600) AND TIPOPARCEIRO = 'F')

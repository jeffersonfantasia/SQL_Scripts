...
SELECT ROWID,
  ...
  FROM PCNFENT E
 WHERE 1 = 1
   AND NUMTRANSENT IN (1799805, 1799806 ,1799807, 1799808) 
   --AND  NUMNOTA IN ( 4612444 )
	 --AND CODFORNEC = 9678 
 --AND E.DTENT >= '01/10/2024'
 --AND E.CODCONT = 3201
 ORDER BY DTENT DESC;
;
/*CONSULTAR NA PCLANC NUMNOTA*/
  SELECT  L.NOMEFUNC, L.CODCONTA, l.recnumprinc, L.DTCOMPETENCIA,
   ...
   WHERE 1 = 1
	 AND L.NUMNOTA  IN (20927)
   --AND (CODFORNEC IN (9691) AND TIPOPARCEIRO = 'F')

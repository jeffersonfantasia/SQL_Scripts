...
SELECT E.DTLANCTO,
  ...
  FROM PCNFENT E
 WHERE 1 = 1
   --AND NUMTRANSENT IN (289 )
   AND NUMNOTA IN ( 2490,2491,2501 ) 
  --AND CODFORNEC = 10713    
  AND E.DTENT >= '01/02/2026'
	--AND E.CODFILIAL = '12'
--AND E.CODCONT = 3201
 ORDER BY E.DTENT DESC;
;
 
SELECT * FROM BI_SINC_CONTABILIDADE C WHERE C.DOCUMENTO = 754686501;

/*CONSULTAR NA PCLANC NUMNOTA*/
SELECT L.NOMEFUNC,
       L.CODCONTA,L.CODFORNEC,
 ...
 WHERE 1 = 1
   AND L.NUMNOTA IN ( 2490,2491,2501) 
   AND (CODFORNEC IN (10491) AND TIPOPARCEIRO = 'F')
      --AND L.DTDESD IS NULL
   AND M.DTESTORNO IS NULL
      --AND L.DTLANC >= '01/10/2024' 
  AND L.DTCOMPETENCIA >= '01/02/2026'

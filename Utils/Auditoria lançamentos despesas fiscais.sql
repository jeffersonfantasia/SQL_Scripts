...
SELECT E.DTLANCTO,
 ...
 WHERE E.DTCANCEL IS NULL	 
	 AND ((E.ESPECIE = 'NF' AND B.CODFISCAL IN (1911, 1923, 2923, 1949, 2949)) OR
       ...
       (E.CODCONT IN (3201, 3401, 3411, 410101, 410102, 410103, 410104) AND B.CODFISCAL NOT IN (1933, 2933)) OR
       (E.CODCONT NOT IN (3201, 3401, 3411, 410101, 410102, 410103, 410104) AND B.CODFISCAL IN (1933, 2933)) OR

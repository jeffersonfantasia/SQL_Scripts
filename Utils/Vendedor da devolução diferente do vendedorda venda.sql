...
USING (
  ...
  SELECT M.NUMTRANSITEM, M.CODUSUR, V.CODUSUR_VENDA
    FROM PCMOV M
    JOIN VENDEDOR_VENDA V ON V.NUMTRANSENT = M.NUMTRANSENT
   WHERE M.CODUSUR <> V.CODUSUR_VENDA) X 
 ON (M.NUMTRANSITEM = X.NUMTRANSITEM) 
 WHEN MATCHED THEN
    UPDATE SET M.CODUSUR = X.CODUSUR_VENDA;
-------------------------------------------------------
...
USING (
  ...
  SELECT E.NUMTRANSENT,
    ...
    FROM PCNFENT E
    JOIN VENDEDOR_VENDA V ON V.NUMTRANSENT = E.NUMTRANSENT
   WHERE E.CODUSURDEVOL <> V.CODUSUR_VENDA) X 
 ON (E.NUMTRANSENT = X.NUMTRANSENT) 
 WHEN MATCHED THEN
    UPDATE SET E.CODUSURDEVOL = X.CODUSUR_VENDA;
-------------------------------------------------------

----BROKERCONTABIL
SELECT B.ROWID, B.* FROM BROKERCONTABIL B WHERE B.CODCONTAB IN (81178, 80204) ORDER BY CODCONTAB, CODFORNEC ;
SELECT F.CGC, B.* FROM BROKERCONTABIL B JOIN PCFORNEC F ON B.CODFORNEC = F.CODFORNEC WHERE B.CODCONTAB IN (66327, 66393) AND B.CODFILIAL = '10';
...
SELECT ROWID, P.NUMCHEQUE,  P.NUMTRANSVENDA, P.DTESTORNO, P.* FROM PCPREST P WHERE P.CODFILIAL = '7' AND P.DUPLIC IN ( 386637, 386662  ) ORDER BY P.NUMTRANSVENDA, TO_NUMBER(PREST); --104479/ 104472

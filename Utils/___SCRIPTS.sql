...
UPDATE PCPEDC SET POSICAO = 'L' WHERE POSICAO NOT IN ('C', 'F') AND  CONDVENDA = 7 AND NUMPED IN (14211947,14212115,14212116);
UPDATE PCPEDI SET POSICAO = 'L' WHERE POSICAO NOT IN ('C', 'F') AND NUMPED IN (14211947,14212115,14212116);

...
----PCBANCO
SELECT ROWID,B.CODBACEN, B.CODFILIAL, B.* FROM PCBANCO B ORDER BY B.CODBANCO DESC;
...
--UPDATE
SELECT ROWID, L.VALOR, L.VPAGO, L.NUMBANCO, L.* FROM PCLANC L WHERE L.NUMTRANS IN (571304,571305);
SELECT ROWID, M. * FROM PCMOVCR M WHERE M.NUMTRANS IN (571304,571305);

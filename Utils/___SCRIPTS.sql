...
SELECT ROWID, L.DTCOMPETENCIA, L.RECNUMPRINC, l.fornecedor, L. * FROM PCLANC L WHERE L.RECNUM IN (6911187,6911863);
...
SELECT C.CONTAORDEM, C.CONDVENDA, C.CODCOB, rowid, C.* FROM PCPEDC C WHERE C.NUMPED = 14211669;
...
----PCPEDIDO
SELECT P.ROWID, P.CODCOMPRADOR, P.* FROM PCPEDIDO P WHERE P.NUMPED IN( 220546 ); --217 VAREJO / 216 DISTRIBUIÇÃO

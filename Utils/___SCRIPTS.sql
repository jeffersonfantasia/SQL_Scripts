...
SELECT rowid, C.* FROM PCCONTA C WHERE C.CODCONTA IN (3407,3413,3700,3703,3704,3752) ; 
...
SELECT ROWID, L.DTCOMPETENCIA, L.RECNUMPRINC, l.fornecedor, L.NUMTRANS, L. * FROM PCLANC L WHERE L.RECNUM IN (7129186,7130128, 548787);
...
----PCMOVCR
SELECT ROWID, M.DTCOMPENSACAO, M.ESTORNO, M.DTESTORNO, M.* FROM PCMOVCR M WHERE M.NUMTRANS IN (575786 )ORDER BY NUMSEQ;
...
SELECT V.ROWID, V.* FROM PCVALECX V WHERE V.DTLANC =   TO_DATE('11/03/2025', 'DD/MM/YYYY');

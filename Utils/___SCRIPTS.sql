...
----PCFORNEC
SELECT F.ROWID, F.OBS2, F.REVENDA, F.* FROM PCFORNEC F WHERE F.FORNECEDOR LIKE '%NEOCOUNT%'; 
...
SELECT ROWID, P.DTESTORNO,P.NUMTRANS,  P.CODBANCO, P. * FROM PCPREST P WHERE P.NUMTRANS IN (543250);
...
SELECT ROWID, P.NUMTRANSVENDA, P.CODCOBORIG, P.OBSTITULO, P.* FROM PCPREST P WHERE P.NSUHOST IN ( '340461754' );
SELECT ROWID, P.NUMTRANSVENDA, P.CODCOBORIG, P.OBSTITULO, P.* FROM PCPREST P WHERE P.NSUTEF IN ( '382918432' );

...
SELECT ROWID, B.* FROM BI_SINC_FORNECEDOR_CONTA B WHERE B.CODCONTABIL IN (1281); 
...
SELECT ROWID, M.CODSITTRIBPISCOFINS, M.DTCANCEL, M.DESCRICAO, M.CODFISCAL, M.NUMPED, M.ROTINALANC, M.* FROM PCMOV M WHERE M.NUMTRANSVENDA IN (22348514);

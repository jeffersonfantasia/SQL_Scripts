...
SELECT ROWID, L.DTCOMPETENCIA, L.RECNUMPRINC, l.fornecedor, L.NUMTRANS, L. * FROM PCLANC L WHERE L.RECNUM IN (7341192, 7341193);
SELECT ROWID, L.DTCOMPETENCIA, L.FORNECEDOR, L.RECNUMPRINC, L.* FROM PCLANC L WHERE L.RECNUMPRINC IN (7345046 ,7347453 ) ORDER BY CODFORNEC, NUMNOTA;
...
SELECT * FROM PCPRODUT P WHERE P.CODAUXILIAR = 7898737383465;

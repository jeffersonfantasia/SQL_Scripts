----BROKERCONTABIL
SELECT B.ROWID, B.* FROM BROKERCONTABIL B WHERE B.CODCONTAB IN (65799, 9520,10078 ) ORDER BY CODCONTAB, CODFORNEC ;
...
SELECT C.CONTACONTABIL, C.* FROM PCCONTA C WHERE C.TIPO <> 'I' AND C.GRUPOCONTA IN ( 620 ) ORDER BY C.GRUPOCONTA, CODCONTA;

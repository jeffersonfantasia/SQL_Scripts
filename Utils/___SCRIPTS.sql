...
----PCFORNEC
SELECT F.ROWID, F.OBS2, F.REVENDA, F.TIPOFORNEC, F.CODCONTAB, F.CGC, F.* FROM PCFORNEC F WHERE INSTR(F.FORNECEDOR, 'SMARTHINT') > 0; 
...
SELECT ROWID, L.DTCOMPETENCIA, L.DTESTORNOBAIXA, L.CODFUNCBAIXA, L.CODFUNCULTALTER, L.ADIANTAMENTO, L.VLRUTILIZADOADIANTFORNEC, L.* FROM PCLANC L WHERE L.CODFORNEC IN ( 10673 ) AND TIPOPARCEIRO = 'F' ORDER BY L.DTPAGTO DESC;

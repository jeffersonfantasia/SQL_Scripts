...
SELECT C.CODREDE, C.* FROM PCCLIENT C WHERE C.CLIENTE LIKE '%SILVANA GENNY TREVIZOLI%';
...
SELECT ROWID, L.DTCOMPETENCIA, L.DTESTORNOBAIXA, L.NUMTRANS, L.* FROM PCLANC L WHERE L.NUMNOTA IN (185) AND L.CODFORNEC = 18258;
...
SELECT P.ROWID, P.NUMTRANSVENDA, P.CODCOBORIG, P.OBSTITULO, P.* FROM PCPREST P WHERE P.NUMTRANSVENDA IN (10181234) ORDER BY TO_NUMBER(PREST);

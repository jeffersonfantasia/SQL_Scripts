...
SELECT ROWID, L.DTCOMPETENCIA, L.DTLANC, L.DTEMISSAO, L.DTVENC, L.DTPAGTO, l.dtestornobaixa, L.* FROM PCLANC L WHERE L.NUMTRANS IN ( 545391 ); 
...
SELECT ROWID, L.DTCOMPETENCIA, L.FORNECEDOR, L.* FROM PCLANC L WHERE L.CODCONTA IN (420104) ORDER BY L.DTPAGTO DESC;

...
----PCCLIENT
SELECT C.CALCULAST, C.CONTRIBUINTE, C.CONSUMIDORFINAL, C.IEENT, C.* FROM PCCLIENT C WHERE C.CODCLI = 470571;
...
SELECT ROWID, C.* FROM PCCRECLI C WHERE C.CODCLI = 419628 ORDER BY C.CODIGO;
SELECT ROWID, C.* FROM PCCRECLI C WHERE C.NUMNOTADESC = 14418 ORDER BY C.CODIGO;


----PCCONTA
SELECT C.CONTACONTABIL, C.* FROM PCCONTA C WHERE C.TIPO <> 'I' AND C.GRUPOCONTA IN ( 530, 535, 540, 545, 550, 555, 560, 565, 660) ORDER BY C.GRUPOCONTA;
...
----PCMOV
SELECT M.NUMTRANSENT, M.DESCRICAO, M.* FROM PCMOV M WHERE M.NUMTRANSDEV IN (11413021,11420013,11416457);
...
SELECT M.DESCRICAO, M.* FROM PCMOV M WHERE M.NUMTRANSVENDA = 11622268;
SELECT M.NUMTRANSDEV, M.DESCRICAO, M.CODFISCAL, M.* FROM PCMOV M WHERE M.NUMTRANSENT IN (460647);


----PCNFENT
SELECT E.VLFRETE, E.FORNECEDOR, E.CHAVENFE, E.* FROM PCNFENT E WHERE E.NUMTRANSENT IN (545328);
SELECT E.NUMTRANSENT, E.FORNECEDOR, E.* FROM PCNFENT E WHERE E.NUMNOTA IN (305188) ;
SELECT E.DTCANCEL, E.* FROM PCNFENT E WHERE E.DTENT BETWEEN '01/01/2023' AND '31/01/2023' AND E.CODFILIAL = '9' AND E.ESPECIE = 'CT';


----PCNFSAID
SELECT S.VLFRETE, S.NUMTRANSVENDA, S.CLIENTE, S.CHAVENFE, S.* FROM PCNFSAID S WHERE S.NUMTRANSVENDA = 11622268; 
SELECT S.NUMTRANSVENDA, S.* FROM PCNFSAID S WHERE S.CODCLI = 419628;
SELECT S.NUMTRANSVENDA, S.CODCOB,  S.* FROM PCNFSAID S WHERE S.CODFILIAL = '7' AND S.NUMNOTA IN (340836);
...
SELECT ROWID, C.NUMTRANSVENDA, C.NUMPEDCLI, C.* FROM PCPEDC C WHERE C.NUMPEDCLI = '571784' ;


----PCPEDCTEMP
SELECT * FROM PCPEDCTEMP P WHERE P.NUMPEDCLI = '571784';

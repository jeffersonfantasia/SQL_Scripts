...
SELECT ROWID, B.* FROM BI_SINC_FORNECEDOR_CONTA B WHERE B.CODCONTABIL IN (81412); 
...
SELECT ROWID, L.DTCOMPETENCIA, L.RECNUMPRINC, l.fornecedor, L.NUMTRANS, L. * FROM PCLANC L WHERE L.RECNUM IN (7342842, 7342861);
SELECT ROWID, L.DTCOMPETENCIA, L.FORNECEDOR, L.RECNUMPRINC, L.* FROM PCLANC L WHERE L.RECNUMPRINC IN (7342841 ,7342860 ) ORDER BY CODFORNEC, NUMNOTA;
...
SELECT ROWID, L.DTCOMPETENCIA, L.DTESTORNOBAIXA, L.NUMTRANS, L.RECNUMPRINC, L.VLISS, L.* FROM PCLANC L WHERE L.NUMNOTA IN (24391,214096) AND L.CODFORNEC = 10477;
...
SELECT ROWID, L.DTCOMPETENCIA,l.dtestornobaixa, L.* FROM PCLANC L WHERE L.CODFORNEC IN ( 9681 ) AND TIPOPARCEIRO = 'F'  ORDER BY L.DTPAGTO DESC;
...
SELECT ROWID, P.NUMCHEQUE,  P.NUMTRANSVENDA, P.DTESTORNO, p.nsuhost, P.NSUTEF, P.CODBARRA, P.* FROM PCPREST P WHERE P.CODFILIAL = '12' AND P.DUPLIC IN ( 5026 ) AND DTPAG IS NULL ORDER BY P.NUMTRANSVENDA, TO_NUMBER(PREST); --104479/ 104472
...
SELECT ROWID, P.NUMTRANSVENDA, P.CODCOBORIG, P.OBSTITULO, P.NUMRESUMO, P.PRESTTEF, P.* FROM PCPREST P WHERE P.NSUHOST IN ( '510873196' ) ORDER BY P.NUMTRANSVENDA, TO_NUMBER(PREST);
SELECT ROWID, P.NUMTRANSVENDA, P.CODCOBORIG, P.OBSTITULO, p.nsutef, P.PRESTTEF, P.* FROM PCPREST P WHERE P.NSUTEF IN ( '511871280') ORDER BY P.NUMTRANSVENDA, TO_NUMBER(PREST);
SELECT P.NUMTRANSVENDA, P.CODCOBORIG, P.OBSTITULO, P.* FROM PCPREST P WHERE P.NUMRESUMO = '076232846';
SELECT P.NSUHOST, P.NSUTEF, P.NUMTRANSVENDA, P.*, P.ROWID FROM PCPREST P WHERE P.DTEMISSAO = '01/07/2026'/* >= TRUNC(SYSDATE) - 9*/ AND P.CODFILIAL = '12' /*AND P.NSUHOST IS NULL*/ AND P.CODCOB NOT IN ('CRED', 'D', 'PIXL', 'CONV', 'CANC') ORDER BY P.NUMTRANSVENDA, P.PREST;

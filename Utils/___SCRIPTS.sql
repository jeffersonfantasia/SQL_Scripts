...
SELECT ROWID, L.DTCOMPETENCIA, L.DTESTORNOBAIXA, L.NUMTRANS, L.RECNUMPRINC, L.* FROM PCLANC L WHERE L.CODFILIAL = '8' AND L.CODFORNEC = 10260 AND L.DTLANC = TRUNC(SYSDATE) - 0 AND L.CODCONTA = 100003;
...
----PCMOVCR
SELECT ROWID, M.DTCOMPENSACAO, M.* FROM PCMOVCR M WHERE M.NUMTRANS IN (320071);

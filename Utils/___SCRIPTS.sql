...
SELECT ROWID, B.* FROM BI_SINC_FORNECEDOR_CONTA B WHERE B.CODCONTABIL IN (83784); 
...
SELECT ROWID, F.OBS2, CODFORNECPRINC, F. * FROM PCFORNEC F WHERE F.CODFORNEC IN (9825); --48.824.508/0001-30

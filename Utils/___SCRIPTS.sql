...
SELECT ROWID, L.DTCOMPETENCIA, L.* FROM PCLANC L WHERE L.CODFORNEC IN ( 10713 ) AND TIPOPARCEIRO = 'F' AND L.CODCONTA = 3850 AND L.DTPAGTO IS NULL ORDER BY L.DTVENC ;
...
SELECT m.dtcancel, M.CODST, M.NUMTRANSITEM, M.NUMTRANSENT, M.NUMTRANSVENDA, M.NUMTRANSDEV, M.DESCRICAO, M.CODFISCAL, M.* FROM PCMOV M WHERE M.numnota IN ( 5542  ) AND CODFILIAL = '13';
...
SELECT V.ROWID, V.* FROM PCVALECX V WHERE V.DTLANC =   TO_DATE('14/10/2025', 'DD/MM/YYYY');

...
SELECT ROWID, B.* FROM BI_SINC_FORNECEDOR_CONTA B WHERE B.CODCONTABIL IN (84276, 84275); 
SELECT ROWID, B.* FROM BI_SINC_FORNECEDOR_CONTA B WHERE B.CODFORNEC IN (9398);
SELECT CODFORNEC, FORNECEDOR, CGC FROM PCFORNEC WHERE CODFORNEC = 10306; 
...
----PCFORNEC
SELECT F.ROWID, F.OBS2, F.REVENDA, F.TIPOFORNEC, F.CODCONTAB, F.CGC, F.* FROM PCFORNEC F WHERE INSTR(F.FORNECEDOR, 'SURA') > 0; 
...
SELECT ROWID, L.DTCOMPETENCIA, L.RECNUMPRINC, l.fornecedor, L.NUMTRANS, L. * FROM PCLANC L WHERE L.RECNUM IN (7343008);
...
SELECT ROWID, L.DTCOMPETENCIA, L.DTLANC, L.DTEMISSAO, L.DTVENC, L.DTPAGTO, l.dtestornobaixa, l.numbanco, L.NUMTRANS, L.* FROM PCLANC L WHERE L.NUMTRANS IN ( 594012  ); 
...
SELECT M.ROWID, M.DTCANCEL, M.NUMTRANSDEV, M.DESCRICAO, M.CODFISCAL, M.PERCICMRED, M.NUMPED, M.* FROM PCMOV M WHERE M.NUMTRANSENT IN (1863523 );
...
----PCPEDIDO
SELECT P.ROWID, P.CODCOMPRADOR, P.CODFILIAL, P.CODFILIALPRINC, P.* FROM PCPEDIDO P WHERE P.NUMPED IN( 224494 ); --217 VAREJO / 216 DISTRIBUICAO
...
SELECT ROWID, P.NUMTRANSVENDA, P.CODCOBORIG, P.OBSTITULO, P.NUMRESUMO, P.PRESTTEF, P.* FROM PCPREST P WHERE P.NSUHOST IN ( '344449888' ) ORDER BY P.NUMTRANSVENDA, TO_NUMBER(PREST);
SELECT ROWID, P.NUMTRANSVENDA, P.CODCOBORIG, P.OBSTITULO, p.nsutef, P.PRESTTEF, P.* FROM PCPREST P WHERE P.NSUTEF IN ( '24475430') ORDER BY P.NUMTRANSVENDA, TO_NUMBER(PREST);

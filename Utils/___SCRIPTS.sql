...
----PCMOVCR
SELECT ROWID, M.DTCOMPENSACAO, M.ESTORNO, M.DTESTORNO, M.* FROM PCMOVCR M WHERE M.NUMTRANS IN (589749, 593579)ORDER BY NUMSEQ;
...
SELECT ROWID, P.DTESTORNO,P.NUMTRANSVENDA, P.NUMTRANS,  P.CODBANCO, P. * FROM PCPREST P WHERE P.NUMTRANS IN (582699);
...
SELECT ROWID, P.NUMTRANSVENDA, P.CODCOBORIG, P.OBSTITULO, p.nsutef, P.PRESTTEF, P.* FROM PCPREST P WHERE P.NSUTEF IN ( '3426') ORDER BY P.NUMTRANSVENDA, TO_NUMBER(PREST);

...
SELECT ROWID, L.DTCOMPETENCIA, L.DTLANC, L.DTEMISSAO, L.DTVENC, L.DTPAGTO, l.dtestornobaixa, L.* FROM PCLANC L WHERE L.NUMTRANS IN ( 557242); 
...
----PCMOVCR
SELECT ROWID, M.DTCOMPENSACAO, M.ESTORNO,  M.* FROM PCMOVCR M WHERE M.NUMTRANS IN ( 557242 ) ORDER BY NUMSEQ;
...
----PCPRODFILIAL
SELECT F.ENVIARFORCAVENDAS, F.* FROM PCPRODFILIAL F WHERE F.CODPROD = 824891;

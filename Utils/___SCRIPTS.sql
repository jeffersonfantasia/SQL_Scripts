...
----PCMOVCR
SELECT ROWID, M.DTCOMPENSACAO, M.ESTORNO,  M.* FROM PCMOVCR M WHERE M.NUMTRANS IN ( 552654 ) ORDER BY NUMSEQ;
...
----PCPEDIDO
SELECT P.ROWID, P.CODCOMPRADOR, P.* FROM PCPEDIDO P WHERE P.NUMPED IN( 217 ); --217 VAREJO / 216 DISTRIBUIÇÃO

...
/*MUDAR PARA 8210 OU 10340 JAMEF*/ 
SELECT ROWID,
       L.CODFORNEC,L.FORNECEDOR,
       L.*
  FROM PCLANC L
 ...
 /*MUDAR PARA 10354 NPJ*/
SELECT ROWID,
       L.CODFORNEC,L.FORNECEDOR,
       L.*
  FROM PCLANC L
 WHERE CODFORNEC  IN ( 7353, 10118)
   AND DTPAGTO >= '01/04/2025';
...
/*MUDAR PARA 10306 CAMILO DOS SANTOS*/  	 
SELECT ROWID,
       L.CODFORNEC,L.FORNECEDOR,
       L.*
  FROM PCLANC L
 WHERE CODFORNEC = 10366 AND CODROTINABAIXA NOT IN (1206)
   AND DTPAGTO >= '01-JAN-2024';

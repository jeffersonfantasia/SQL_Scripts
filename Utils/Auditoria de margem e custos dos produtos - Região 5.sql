...
WITH PRODUTOS AS
 (SELECT E.CODFILIAL,
         ...
         L.CUSTOLIQ,
         T.MARGEM MIDEAL,
         FN_JF_MARGEM_PRECO(L.CUSTOLIQ, T.PVENDA, FN_JF_TRANSFORMA_EM_PERCENTUAL(B.CODICMTAB)) MPRECO,
         /* FN_JF_MARGEM_PRECO(L.CUSTOLIQ,
         L.PCOMPRA,
         FN_JF_TRANSFORMA_EM_PERCENTUAL(B.CODICMTAB)) MSUGERIDA,*/
         FN_JF_MARGEM_PRECO(L.CUSTOLIQ,
                            FN_JF_PRECO_VENDA(L.CUSTOLIQ, 10, FN_JF_TRANSFORMA_EM_PERCENTUAL(B.CODICMTAB)),
                            FN_JF_TRANSFORMA_EM_PERCENTUAL(B.CODICMTAB)) MSUGERIDA,
         ...
         FN_JF_PRECO_VENDA(L.CUSTOLIQ, 0.10, FN_JF_TRANSFORMA_EM_PERCENTUAL(B.CODICMTAB)) PSUGERIDO,
         T.PTABELA,

...
SELECT E.CODFILIAL,
  ...
  FROM PCEST E
  JOIN PCPRODUT P ON E.CODPROD = P.CODPROD
  LEFT JOIN CUSTOS_FILIAL_F13 C ON E.CODPROD = C.CODPROD
...
/*filial 2 e 3*/
  ...
  SELECT E.CODFILIAL,
   ...
   WHERE E.CODFILIAL = '4'
     ...
     AND (NVL(E.VALORULTENT, 0) = 0 OR NVL(E.CUSTOULTENT, 0) = 0 OR
         NVL(E.CUSTOFIN, 0) = 0 OR NVL(E.CUSTOREAL, 0) = 0 OR
         NVL(E.CUSTOCONT, 0) = 0 OR NVL(E.CUSTOREP, 0) = 0)) X ON (E.CODPROD = X.CODPROD AND E.CODFILIAL = X.CODFILIAL) 
				 WHEN MATCHED THEN UPDATE SET E.VALORULTENT = X.VALORULTENT_F, E.CUSTOULTENT = X.CUSTOULTENT_F, E.CUSTOFIN = X.CUSTOFIN_F, E.CUSTOREAL = X.CUSTOREAL_F, E.CUSTOCONT = X.CUSTOCONT_F, E.CUSTOREP = X.CUSTOREP_F;

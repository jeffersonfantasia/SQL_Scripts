...
SELECT M.DTMOV,
 ...
 WHERE S.CODFILIAL = '9'
     AND ((S.NUMNOTA = 15989 AND M.CODPROD = 815972) OR --(S.NUMNOTA = 15225 AND M.CODPROD = 167084) OR (S.NUMNOTA = 17851 AND M.CODPROD = 811657) OR
         S.NUMNOTA IN (9390,	17983,	12396,	13987,	10386,	12819,	14781,	11458,	12929))----VER SE TEM FRETE PARA LANCAR
...
SELECT M.CODFILIALRETIRA, M.CODPROD, M.DESCRICAO, SUM(M.QT) QTSOMA
 ...
 WHERE S.CODFILIAL = '9'
     AND ((S.NUMNOTA = 15989 AND M.CODPROD = 815972) OR --(S.NUMNOTA = 15225 AND M.CODPROD = 167084) OR (S.NUMNOTA = 17851 AND M.CODPROD = 811657) OR
         S.NUMNOTA IN (9390,	17983,	12396,	13987,	10386,	12819,	14781,	11458,	12929))

...
SELECT M.DTMOV,
 ...
 WHERE S.CODFILIAL = '10'
     AND (--(S.NUMNOTA = 15989 AND M.CODPROD = 815972) OR --(S.NUMNOTA = 15225 AND M.CODPROD = 167084) OR (S.NUMNOTA = 17851 AND M.CODPROD = 811657) OR
         S.NUMNOTA IN (126,20))----VER SE TEM FRETE PARA LANCAR
...
SELECT *
  FROM (SELECT C.CODFILIAL,
               'CREDITO' TIPO,
               (SELECT E.NUMNOTA FROM PCNFENT E WHERE E.NUMTRANSENT = C.NUMTRANSENTDEVCLI) NUMNOTADEV,
               C.CODIGO NUMERO,
               C.DTLANC,
               C.CODCLI CODIGO,
               T.CLIENTE EMPRESA,

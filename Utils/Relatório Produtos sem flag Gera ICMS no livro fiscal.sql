...
UPDATE PCPRODFILIAL
   SET GERAICMSLIVROFISCAL = 'S'
 WHERE GERAICMSLIVROFISCAL IS NULL
   AND CODPROD IN (819494);

UPDATE PCPRODFILIAL
   SET GERAICMSLIVROFISCAL = 'S'
 WHERE GERAICMSLIVROFISCAL = 'N'
   AND CODPROD IN (819064);
...
UPDATE PCPRODFILIAL
   SET GERAICMSLIVROFISCAL = &ICMS, GERAICMSLIVROFISCALENT = &ICMS, GERAICMSLIVROFISCALDEVFORNEC = &ICMS

...
MERGE
 ...
 WHERE T.CODPROD = P.CODPROD
   AND T.CODNCMEX IN ('42029200.')
	 AND P.CODFILIAL NOT IN ('11')
	 AND P.GERAICMSLIVROFISCAL = 'N') X
	 ON (F.CODPROD = X.CODPROD AND F.CODFILIAL = X.CODFILIAL) 
	WHEN MATCHED THEN UPDATE SET F.GERAICMSLIVROFISCAL = 'S', F.GERAICMSLIVROFISCALENT = 'S', F.GERAICMSLIVROFISCALDEVFORNEC = 'S';

...
--SELECT * FROM PCENCERRAMENTOFINANCEIRO F WHERE F.ANO = 2026 AND F.MES = 01 ORDER BY DIA DESC;
--SELECT * FROM PCENCERRAMENTOFINANCEIRO F  ORDER BY ANO DESC, MES DESC, DIA DESC;
...
BEGIN
 PRC_FECHAMENTO_FINANCEIRO(TO_DATE('31/01/2026', 'DD/MM/YYYY'));
END;

...
PRC_SINC_FORNEC_INSERE_CONTA('1', 10750, 84066);


END;

--SELECT * FROM PCENCERRAMENTOFINANCEIRO F WHERE F.ANO = 2025 AND F.MES = 10 ORDER BY DIA DESC;
...
BEGIN
 PRC_FECHAMENTO_FINANCEIRO(TO_DATE('30/11/2025', 'DD/MM/YYYY'));
END;

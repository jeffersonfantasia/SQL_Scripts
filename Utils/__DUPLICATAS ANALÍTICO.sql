...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11508814)
...
UPDATE PCPREST
   SET OBSTITULO = '22/03/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR' -- '10/02/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR'
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN ( 11620397 ) ;
...
USING (SELECT NUMTRANSVENDA,
        ...
        WHERE VPAGO IS NULL
          ...
          AND P.NUMTRANSVENDA IN (11624585) 

...
SELECT NUMCHEQUE,
 ...
 WHERE P.NUMTRANSVENDA IN (11716576)
...
SELECT P.ROWID, P.NUMTRANSVENDA, C.CLIENTE, P.OBSTITULO, P.*
 ...
 WHERE P.DTPAG IS NULL
 AND P.NUMTRANSVENDA IN (11711277); --18/07/2023 - REPASSE BLOQUEADO - FAVOR VERIFICAR

--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '15/08/2023 - DEVOLUCAO A REVISAR - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11738737);

--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '15/08/2023 - MEDIACAO FINALIZADA COM REEMBOLSO PARA COMPRADOR - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11741918);
	 
--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '15/08/2023 - DEV A CAMINHO - PRAZO ATE 01/09' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11741425);

--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '15/08/2023 - DEVOLUCAO PARA RETIRAR NA AGENCIA - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11729413);
	 
--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '15/08/2023 - CANCELADO PELO COMPRADOR - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11742803);

--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '16/08/2023 - FALTA DEVOLUCAO - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11721808);

...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11593397)
...
SELECT P.ROWID, P.NUMTRANSVENDA, C.CLIENTE, P.OBSTITULO, P.*
 ...
 WHERE P.DTPAG IS NULL
   AND P.NUMTRANSVENDA IN (11670729);
...
--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '30/05/2023 - FALTA DEVOLUCAO - FAVOR VERIFICAR' -- 29/05/2023 - CLIENTE IRÁ REALIZAR A DEVOLUÇÃO DO ITEM - ENVIAMOS O CÓDIGO DE POSTAGEM
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11662836);
...
USING (SELECT NUMTRANSVENDA,
        ...
        WHERE VPAGO IS NULL
          ...
          AND P.NUMTRANSVENDA IN (11660116)
...
UPDATE PCPREST
 ...
 WHERE NUMTRANS IS NOT NULL
   AND NUMTRANSVENDA IN (11639022, 11597254);

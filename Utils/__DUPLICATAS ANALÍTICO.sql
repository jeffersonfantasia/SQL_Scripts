...
SELECT P.ROTINAPAG,
 ...
 WHERE P.NUMTRANSVENDA IN (22097377) --8693
 ORDER BY DUPLIC,
          TO_NUMBER(PREST);
...
22380622,
22386106); --18/09/2025 - FAVOR VERIFICAR A FALTA DE RECEBIMENTO ATÉ O MOMENTO


--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '08/01/2026 - FALTA DEVOLUCAO - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL

...
SELECT P.ROWID, P.NUMTRANSVENDA, C.CLIENTE, P.OBSTITULO, P.*
 ...
 WHERE P.DTPAG IS NULL
 AND P.NUMTRANSVENDA IN (22372852); --18/09/2025 - FAVOR VERIFICAR A FALTA DE RECEBIMENTO ATÉ O MOMENTO


--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '19/01/2026 - FALTA DEVOLUCAO - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (22372852);

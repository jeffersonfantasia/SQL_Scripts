...
SELECT NUMCHEQUE,
 ...
 WHERE P.NUMTRANSVENDA IN (11699587)
...
UPDATE PCPREST
   SET OBSTITULO = '21/08/2023 - DEVOLUCAO A REVISAR - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11731382);

--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '21/08/2023 - MEDIACAO FINALIZADA COM REEMBOLSO PARA COMPRADOR - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11747848);
...
--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '21/08/2023 - CANCELADO PELO COMPRADOR - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11748123, 11751719);

--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '22/08/2023 - FALTA DEVOLUCAO - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11687286,
11698619);

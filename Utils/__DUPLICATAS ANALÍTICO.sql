...
SELECT P.ROTINAPAG, P.Codadmcartao, P.CODCOBORIG,
 ...
 WHERE P.NUMTRANSVENDA IN (21896343)
...
SELECT P.CODFILIAL,
 ...
 WHERE P.DTPAG IS NULL
   ...
   AND P.CODFILIAL IN ('7', '9', '10')
	 AND P.CODFILIAL = '9'
   AND P.CODCLI = 63722
 ORDER BY P.CODFILIAL, P.CODCLI;--21943107

--OBSERVAÇÃO TITULOS
SELECT P.ROWID, P.NUMTRANSVENDA, C.CLIENTE, P.OBSTITULO, P.*
  FROM PCPREST P JOIN PCNFSAID C ON C.NUMTRANSVENDA = P.NUMTRANSVENDA
 WHERE P.DTPAG IS NULL
 AND P.NUMTRANSVENDA IN (21904991,21966991);


--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '22/02/2024 - FALTA DEVOLUCAO - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (21986879);

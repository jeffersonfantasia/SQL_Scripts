...
SELECT P.ROWID,
 ...
 WHERE 1 = 1
   AND P.DTPAG IS NULL
   AND P.NUMTRANSVENDA IN (22415909); --18/09/2025 - FAVOR VERIFICAR A FALTA DE RECEBIMENTO ATÉ O MOMENTO

--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '18/03/2026 - FALTA DEVOLUCAO - FAVOR VERIFICAR'
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (22415909);

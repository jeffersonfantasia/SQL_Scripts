...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11721490)
...
--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '18/07/2023 - MEDIACAO FINALIZADA COM REEMBOLSO PARA COMPRADOR - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11694843);
	 
--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '18/07/2023 - DEV A CAMINHO - PRAZO ATE 22/06' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11702796);
...
--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '18/07/2023 - FALTA DEVOLUCAO - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11678287);

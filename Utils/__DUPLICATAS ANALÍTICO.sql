...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11612298)
...
UPDATE PCPREST
   SET OBSTITULO = '17/05/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR' -- '01/04/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR'
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11654326);

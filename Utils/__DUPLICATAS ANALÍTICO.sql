...
SELECT P.ROTINAPAG,
       ...
       P.DTFECHA,
       P.NUMTRANSVENDA,
       P.PRESTTEF,P.NUMCHECKOUT,
       P.*,
       P.ROWID
  FROM PCPREST P
  LEFT JOIN PCCLIENT C ON P.CODCLI = C.CODCLI
 WHERE P.NUMTRANSVENDA IN (22372852) --8693
 ORDER BY DUPLIC,
          TO_NUMBER(PREST);
...
SELECT P.ROWID, P.NUMTRANSVENDA, C.CLIENTE, P.OBSTITULO, P.*
 ...
 WHERE 1 =1 
 --AND P.DTPAG IS NULL
 AND P.NUMTRANSVENDA IN (22411204); --18/09/2025 - FAVOR VERIFICAR A FALTA DE RECEBIMENTO ATÉ O MOMENTO


--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '23/01/2026 - FALTA DEVOLUCAO - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (22398633);
...
SELECT P.ROWID, P.NUMCHEQUE, P.NUMCUSTODIA, P.*
 ...
 WHERE P.NUMTRANS IS NULL
   --AND P.CODCLI = 25047
   AND DTPAG IS NULL 
   AND P.NUMTRANSVENDA IN (22097377,
22380622,
22386106)
;

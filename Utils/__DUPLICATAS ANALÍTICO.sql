...
SELECT P.ROTINAPAG,
 ...
 WHERE P.NUMTRANSVENDA IN ( 22190136 ) --379356721
 ORDER BY DUPLIC,
          TO_NUMBER(PREST);
...
UPDATE PCPREST
   SET OBSTITULO = '09/12/2024 - FALTA DEVOLUCAO - FAZER VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (22189805,
22190136

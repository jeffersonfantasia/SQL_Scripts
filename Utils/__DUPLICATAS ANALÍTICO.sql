...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11628024)
...
UPDATE PCPREST
   SET OBSTITULO = '19/06/2023 - MEDIACAO FINALIZADA COM REEMBOLSO PARA COMPRADOR- FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
...
--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '26/06/2023 - CHAMADO ABERTO PARA R3 - RETORNO EM 4 DIAS UTEIS - 30/06' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (	11678571,
11678837,
11679802,

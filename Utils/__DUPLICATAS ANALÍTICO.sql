...
SELECT P.ROWID,
       ...
       P.*
  FROM PCPREST P
  LEFT JOIN PCCLIENT C ON P.CODCLI = C.CODCLI --11/04/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR
 WHERE P.NUMTRANSVENDA IN (11643219, 11641447)
...
USING (SELECT NUMTRANSVENDA,
        ...
        WHERE VPAGO IS NULL
          ...
          AND P.NUMTRANSVENDA IN (11634581)

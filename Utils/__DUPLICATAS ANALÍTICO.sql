...
SELECT P.ROTINAPAG,
 ...
 WHERE P.NUMTRANSVENDA IN (22169876,22211378
) --568490, 568491, 568492
 ORDER BY DUPLIC,
          TO_NUMBER(PREST);
...
SELECT P.ROWID, P.NUMTRANSVENDA, C.CLIENTE, P.OBSTITULO, P.*
 ...
 WHERE P.DTPAG IS NULL
 AND P.NUMTRANSVENDA IN (22095688,
22089983,
22089983,
22138185,
22138185,
...
UPDATE PCPREST
   SET OBSTITULO = '28/12/2024 - FALTA DEVOLUCAO - FAZER VERIFICAR' 
 WHERE DTPAG IS NULL
...
USING (SELECT NUMTRANSVENDA,
        ...
        WHERE VPAGO IS NULL
          ...
          AND P.NUMTRANSVENDA IN (22194042)

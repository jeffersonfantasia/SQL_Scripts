...
SELECT P.ROTINAPAG, P.Codadmcartao, P.CODCOBORIG,
 ...
 WHERE P.NUMTRANSVENDA IN (21993116)
...
SELECT P.ROWID, P.NUMTRANSVENDA, C.CLIENTE, P.OBSTITULO, P.*
 ...
 WHERE P.DTPAG IS NULL
 AND P.NUMTRANSVENDA IN (21996006);


--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '01/03/2024 - FALTA DEVOLUCAO - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (21918518);

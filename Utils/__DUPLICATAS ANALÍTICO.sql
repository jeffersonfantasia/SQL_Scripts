...
SELECT P.ROWID,
       ...
       P.*
  FROM PCPREST P
  LEFT JOIN PCCLIENT C ON P.CODCLI = C.CODCLI --02/05/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR --17/04/2023 - CHARGEBACK DE MARÇO - FAVOR VERIFICAR 12709824951 
 WHERE P.NUMTRANSVENDA IN (11640407)

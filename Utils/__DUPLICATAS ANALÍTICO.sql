...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11542018, 11560274) --11611219
...
UPDATE PCPREST
   SET OBSTITULO = '23/02/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR' -- '10/02/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR'
 WHERE DTPAG IS NULL
      --AND CODCLI = 25053 --AND codfilial = '9'
   AND NUMTRANSVENDA IN (11618946);
...
USING (SELECT NUMTRANSVENDA,
        ...
        WHERE VPAGO IS NULL
          ...
          AND P.NUMTRANSVENDA IN (11611834)

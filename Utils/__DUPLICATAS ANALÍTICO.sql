...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11641459)
...
UPDATE PCPREST
   SET OBSTITULO = '18/04/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR' -- '01/04/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR'
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11637015,
11638104,
11638648,
11639757,
11640407);
...
USING (SELECT NUMTRANSVENDA,
        ...
        WHERE VPAGO IS NULL
          ...
          AND P.NUMTRANSVENDA IN (11641237)
...
UPDATE PCPREST
 ...
 WHERE NUMTRANS IS NOT NULL
   AND NUMTRANSVENDA IN (11631276, 11632648, 11637015, 11638104, 11638648);

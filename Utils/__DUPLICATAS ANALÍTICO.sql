...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11607622)
...
UPDATE PCPREST
   SET OBSTITULO = '13/03/2023 - CASO DA BANHEIRA INFORMADO AO JOE NO EMAIL - AGUARDANDO POSICIONAMENTO' -- '10/02/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR'
 WHERE DTPAG IS NULL
      --AND CODCLI = 25053 --AND codfilial = '9'
   AND NUMTRANSVENDA IN ( 11634497 );

...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11668482, 11668393)
...
SELECT P.ROWID, P.NUMTRANSVENDA, C.CLIENTE, P.OBSTITULO, P.*
 ...
 WHERE P.DTPAG IS NULL
   AND P.NUMTRANSVENDA IN (11670066);

--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '29/05/2023 - PEDIDO CANCELADO - FAVOR VERIFICAR' -- 29/05/2023 - CLIENTE IRÁ REALIZAR A DEVOLUÇÃO DO ITEM - ENVIAMOS O CÓDIGO DE POSTAGEM
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11669826);
...
USING (SELECT NUMTRANSVENDA,
        ...
        WHERE VPAGO IS NULL
          ...
          AND P.NUMTRANSVENDA IN (11655865)

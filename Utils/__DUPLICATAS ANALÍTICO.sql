...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11620738, 11620720)
...
UPDATE PCPREST
   SET OBSTITULO = '06/04/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR' -- '01/04/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR'
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN ( 11625654,
11631966 ) ;

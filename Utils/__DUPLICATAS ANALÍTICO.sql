...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11524115)
...
UPDATE PCPREST
   SET OBSTITULO = '31/01/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR'
 WHERE DTPAG IS NULL
      --AND CODCLI = 25053 --AND codfilial = '9'
   AND NUMTRANSVENDA IN (11607313);
...
SELECT P.ROWID, P.NUMCHEQUE, P.*
 ...
 WHERE P.NUMTRANS IS NOT NULL
   AND P.NUMTRANSVENDA IN (11524115,
11549441,
11576242,
11584129,
11595257,

...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11619688) --11611219
...
UPDATE PCPREST
   SET OBSTITULO = '09/03/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR' -- '10/02/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR'
 WHERE DTPAG IS NULL
      --AND CODCLI = 25053 --AND codfilial = '9'
   AND NUMTRANSVENDA IN (11631778,11623849,11626028 );
...
SELECT P.ROWID, P.NUMCHEQUE, P.*
 ...
 WHERE P.NUMTRANS IS NULL
   AND P.CODCLI = 25047
   AND DTPAG IS NULL 
   AND P.NUMTRANSVENDA IN (11509710)
);

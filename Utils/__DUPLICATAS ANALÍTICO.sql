...
SELECT P.ROTINAPAG,
 ...
 WHERE P.NUMTRANSVENDA IN (22322687) --8693
 ORDER BY DUPLIC,
          TO_NUMBER(PREST);
...
SELECT P.ROWID, P.NUMTRANSVENDA, C.CLIENTE, P.OBSTITULO, P.*
 ...
 WHERE P.DTPAG IS NULL
 AND P.NUMTRANSVENDA IN (22323759);


--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '08/08/2025 - FALTA DEVOLUCAO - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (22338322);

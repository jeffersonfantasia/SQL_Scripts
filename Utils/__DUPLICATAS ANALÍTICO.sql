...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11494483)
...
UPDATE PCPREST
   SET OBSTITULO = '02/02/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR' --
 WHERE DTPAG IS NULL
      --AND CODCLI = 25053 --AND codfilial = '9'
   AND NUMTRANSVENDA IN (11552569);
...
SELECT P.ROWID, P.NUMCHEQUE, P.*
 ...
 WHERE P.NUMTRANS IS NOT NULL
   AND P.NUMTRANSVENDA IN (11547203, 11559413, 11586052);
...
--SET NUMCHEQUE = 3
 ...
 WHERE NUMTRANS IS NOT NULL
   AND NUMTRANSVENDA IN (11547203, 11559413, 11586052);

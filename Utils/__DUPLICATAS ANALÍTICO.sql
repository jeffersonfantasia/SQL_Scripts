...
SELECT P.ROTINAPAG,
 ...
 WHERE P.NUMTRANSVENDA IN (22219032,22224105 )
 ORDER BY DUPLIC,
          TO_NUMBER(PREST);
...
UPDATE PCPREST
   SET OBSTITULO = '07/01/2025 - FALTA DEVOLUCAO - FAZER VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (22224105);

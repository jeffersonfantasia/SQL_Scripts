...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11486284)
...
UPDATE PCPREST
   SET OBSTITULO = '17/03/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR' -- '10/02/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR'
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN ( 11636445 ) ;

...
SELECT P.ROTINAPAG, P.Codadmcartao, P.CODCOBORIG,P.CODBANCO,
       P.CODBANCO,
       C.CLIENTE,
			 P.DTESTORNO,
       P.VALORESTORNO,
 ...
 WHERE P.NUMTRANSVENDA IN (11759758)
...
--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '14/01/2023 - FALTA DEVOLUCAO - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL

...
SELECT NUMCHEQUE,
 ...
 WHERE P.NUMTRANSVENDA IN (11829167)
...
--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '22/11/2023 - FALTA DEVOLUCAO - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11796411,
11824534,
11846330,
21850225);

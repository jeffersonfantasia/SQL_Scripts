...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11599739)  --11614812 b2b
...
UPDATE PCPREST
   SET OBSTITULO = '30/01/2023 - EM DEVOLUCAO PELA MANDAE - PRAZO 02/02/2023 - CHAMADO 1621503'
 WHERE DTPAG IS NULL
   --AND CODCLI = 25053 --AND codfilial = '9'
   AND NUMTRANSVENDA IN (11515226,
11528648,
11524177,
11583588
);
...
USING (SELECT NUMTRANSVENDA,
        ...
        WHERE VPAGO IS NULL
          ...
          AND P.NUMTRANSVENDA IN (11583595, 11554644)

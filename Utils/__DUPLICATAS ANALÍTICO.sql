...
SELECT P.ROTINAPAG,
 ...
 WHERE P.NUMTRANSVENDA IN (22388818) --8693
 ORDER BY DUPLIC,
          TO_NUMBER(PREST);
...
SELECT P.ROWID,
 ...
 WHERE 1 = 1
   AND P.DTPAG IS NULL
   AND P.NUMTRANSVENDA IN (22408130); --18/09/2025 - FAVOR VERIFICAR A FALTA DE RECEBIMENTO ATÉ O MOMENTO

--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '11/02/2026 - FALTA DEVOLUCAO - FAVOR VERIFICAR'
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (22408130);
...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANS IS NULL
      --AND P.CODCLI = 25047
   AND DTPAG IS NULL
   AND P.NUMTRANSVENDA IN (22097377, 22380622, 22386106);

--UPDATE DUPLICATA A ESTORNAR EM LOTE
UPDATE PCPREST
   SET NUMCHEQUE = 3
 WHERE NUMTRANS IS NOT NULL
   AND NUMTRANSVENDA IN (22097377);

...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11612279) --11611219
...
UPDATE PCPREST
   SET OBSTITULO = '16/02/2023 - EM DEVOLUÇÃO PELA MANDAE - PRAZO ATÉ 10/03/2023' -- '10/02/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR'
 WHERE DTPAG IS NULL
      --AND CODCLI = 25053 --AND codfilial = '9'
   AND NUMTRANSVENDA IN (11618234);
...
USING (SELECT NUMTRANSVENDA,
        ...
        WHERE VPAGO IS NULL
          ...
          AND P.NUMTRANSVENDA IN (11612141, 11612460)
...
SELECT P.ROWID, P.NUMCHEQUE, P.*
 ...
 WHERE P.NUMTRANS IS NULL
   AND P.CODCLI = 25047
   AND DTPAG IS NULL
   AND P.NUMTRANSVENDA IN (11582805,
                           11584129,
                           11585530,
                           11544262,
                           11575427,
...
UPDATE PCPREST
 ...
 WHERE NUMTRANS IS NOT NULL
   AND NUMTRANSVENDA IN
       (11603497, 11611219, 11611644, 11509710, 11584547, 11607380);

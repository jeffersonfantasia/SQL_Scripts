...
SELECT P.ROTINAPAG, P.Codadmcartao, P.CODCOBORIG,
 ...
 WHERE P.NUMTRANSVENDA IN (21890775)
...
SELECT P.ROWID, P.NUMTRANSVENDA, C.CLIENTE, P.OBSTITULO, P.*
 ...
 WHERE P.DTPAG IS NULL
 AND P.NUMTRANSVENDA IN (21862768,
21886626,
21892612,
21893174,
21893323,
...
21920405,
21941291
); --18/07/2023 - REPASSE BLOQUEADO - FAVOR VERIFICAR
...
--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '15/01/2023 - FALTA DEVOLUCAO - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (21885785);

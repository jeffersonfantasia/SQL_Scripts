...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11446760)
...
SELECT P.ROWID, P.NUMTRANSVENDA, C.CLIENTE, P.OBSTITULO, P.*
 ...
 WHERE P.DTPAG IS NULL
 AND P.NUMTRANSVENDA IN (11675106, 11679008);

--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '07/07/2023 - MEDIACAO FINALIZADA COM REEMBOLSO PARA COMPRADOR - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11688307);
	 
--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '07/07/2023 - DEV A CAMINHO - PRAZO ATE 22/06' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11675084);

--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '07/07/2023 - CANCELADO PELO COMPRADOR - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11679802);

--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '07/07/2023 - FALTA DEVOLUCAO - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11641380);
	 
--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '07/07/2023 - REEMBOLSO SOB GARANTIA DE A-Z - FAVOR VERIFICAR' --ENTREGUE NO DIA 16/06/2023 - QUANDO RECEBEREMOS ESSE VALOR - FAVOR VERIFICAR
 WHERE DTPAG IS NULL

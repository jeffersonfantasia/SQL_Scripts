...
SELECT P.ROWID,
 ...
 WHERE P.NUMTRANSVENDA IN (11618234)  --11611219
...
UPDATE PCPREST
   SET OBSTITULO = '15/02/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR' -- '10/02/2023 - FALTA DEVOLUÇÃO - FAVOR VERIFICAR'
 WHERE DTPAG IS NULL
...
USING (SELECT NUMTRANSVENDA,
        ...
        WHERE VPAGO IS NULL
          ...
          AND P.NUMTRANSVENDA IN (11611297)
...
SELECT P.ROWID, P.NUMCHEQUE, P.*
 ...
 WHERE P.NUMTRANS IS NOT NULL
   AND P.NUMTRANSVENDA IN (11603497,
11611219,
11611644,
11509710,
11584547,

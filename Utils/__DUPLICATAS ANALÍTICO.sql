...
SELECT NUMCHEQUE,
 ...
 WHERE P.NUMTRANSVENDA IN (11652200, 11727031)
...
--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '24/07/2023 - MEDIACAO FINALIZADA COM REEMBOLSO PARA COMPRADOR - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11709003);
...
--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '24/07/2023 - DEVOLVIDO DIA 24/07/2023' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (11711049);

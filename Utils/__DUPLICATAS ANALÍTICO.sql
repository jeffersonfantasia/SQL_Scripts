...
SELECT P.ROTINAPAG,
 ...
 WHERE P.NUMTRANSVENDA IN (21939133 ) --379356721
 ORDER BY DUPLIC,
          TO_NUMBER(PREST);
...
SELECT P.ROWID, P.NUMTRANSVENDA, C.CLIENTE, P.OBSTITULO, P.*
 ...
 WHERE P.DTPAG IS NULL
 AND P.NUMTRANSVENDA IN (22152999);


--UPDATE OBSERVACAO TITULO
UPDATE PCPREST
   SET OBSTITULO = '08/11/2024 - FALTA DEVOLUCAO - FAVOR VERIFICAR' 
 WHERE DTPAG IS NULL
   AND NUMTRANSVENDA IN (22156775,
22170137
);

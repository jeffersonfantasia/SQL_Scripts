...
SELECT P.NUMTRANSVENDA, P.* FROM PCPREST P WHERE NUMTRANSVENDA IN ( 11316383 ) ORDER BY DUPLIC, TO_NUMBER(PREST);
SELECT T.IDPONTOVENDA, T.* FROM PCPRESTTEMP T WHERE T.IDPONTOVENDA IN ( '5025774693', '5060198784');
SELECT ROWID, T.IDPONTOVENDA, T.NSUTEF, T.* FROM PCPRESTTEMP T WHERE T.NUMPEDWEB IN (37512238) ;
SELECT ROWID, T.* FROM PCPEDCTEMP T WHERE T.NUMPEDWEB IN (555552) ;
...
SELECT * FROM PCCRECLI C WHERE C.NUMTRANSVENDA = 11343187;
...
SELECT * FROM PCCRECLI WHERE CODCLI = 401893;
...
SELECT P.ROWID, 
  ...
  LEFT JOIN PCPEDCTEMP T ON W.NUMPEDWEB = T.NUMPEDWEB

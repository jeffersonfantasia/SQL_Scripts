...
SELECT P.DTEMISSAO,
  ...
  LEFT JOIN CREDITOS_ABERTOS A ON S.NUMTRANSVENDA = A.NUMTRANSVENDA
 WHERE P.DTPAG IS NULL 
 --AND CT.NUMPEDCLI IN ( 'LU-1149670885044444','LU-1150370885497637','LU-1152270886968999','LU-1150770885884767','LU-1151470886504482','LU-1147470883637259','LU-1149870885142871', 'LU-1150470885548115')
   AND P.DTVENC < TRUNC(SYSDATE) - 1 
   AND (P.CODCLI = 47730 

...
SELECT C.CLIENTE, P.PRESTTEF, P.ROWID, P.NUMTRANSVENDA, P.NUMTRANS, P.OBSTITULO,P.NSUHOST, P.NSUTEF, P.DTTRANSACAOCC, P.NUMRESUMO, P.PDV, P.CODBAIXACARTAOREDE, P.DTFECHA, P.*
  FROM PCPREST P
  LEFT JOIN PCCLIENT C ON P.CODCLI = C.CODCLI
 WHERE P.NUMTRANSVENDA IN (11396688)
...
SELECT P.DTEMISSAO,
  ...
  LEFT JOIN CREDITOS_ABERTOS A ON S.NUMTRANSVENDA = A.NUMTRANSVENDA
 WHERE P.DTPAG IS NULL 
       --(P.DTPAG IS NULL OR P.CODCOB IN ('CARC', 'CRED'))

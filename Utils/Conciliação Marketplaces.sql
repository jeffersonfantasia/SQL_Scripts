...
SELECT P.NUMTRANSVENDA, P.* FROM PCPREST P WHERE P.NSUHOST IN ( 254847171 ) ORDER BY DUPLIC, TO_NUMBER(PREST);
...
SELECT ROWID, T.* FROM PCPEDCTEMP T WHERE T.NUMPEDCLI LIKE '%295717746601%' ;
...
SELECT --P.ROWID,
       ...
       P.*
  FROM PCPREST P
  INNER JOIN CREDITOS_ABERTOS A ON P.NUMTRANSVENDA = A.NUMTRANSVENDA
 WHERE P.CODCOB = 'CARC'

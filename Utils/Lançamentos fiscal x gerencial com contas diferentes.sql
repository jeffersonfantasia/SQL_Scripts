WITH LANC_PCLANC AS
 (SELECT DISTINCT L.NUMNOTA, L.CODFORNEC, MIN(L.CODCONTA) AS CODCONTA, L.CODFUNCESTORNOBAIXA
    FROM PCLANC L
...
--NAO TRAZER NOTAS CANCELADAS
 WHERE E.DTCANCEL IS NULL
   ...
   AND (E.CODCONT <> NVL(L.CODCONTA, 0) OR E.CODCONT IN (590101) OR E.CODFORNEC <> E.CODFORNECNF)

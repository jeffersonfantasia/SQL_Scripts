...
SELECT L.DTDESBLOQUEIO,
 ...
 WHERE E.MATRICULA = L.CODFUNCDESBLOQUEIO
   ...
   AND L.DTDESBLOQUEIO BETWEEN TO_DATE ('01/04/2020', 'DD/MM/YYYY') AND TO_DATE ('09/04/2020', 'DD/MM/YYYY')
   AND L.CODFILIAL = 1
   AND L.CODPROD = 798648
...
SELECT CODFILIAL,
 ...
 WHERE CODFILIAL = 2
   AND CODPROD = 800489
   AND DATA BETWEEN TO_DATE ('01/04/2020', 'DD/MM/YYYY') AND TO_DATE ('09/04/2020', 'DD/MM/YYYY')
 ORDER BY DATA DESC;
/

WITH ESTOQUEFILIAL_7 AS (
    ...
    SELECT CODPROD,
     ...
     WHERE QTCOMPRA > 0
), ESTOQUE_RESERVA_DISTRIB AS (
    SELECT E.CODPROD,
           (NVL (E.QTBLOQUEADA, 0) - NVL (E.QTINDENIZ, 0)) AS QTBLOQ_F1
      FROM PCEST E
     WHERE E.CODFILIAL = 1
       AND E.CODDEVOL = 46
)

   ...
   (CASE WHEN :TIPOPRIORIDADEENTREGA = 'N'  THEN 'M' ELSE :TIPOPRIORIDADEENTREGA END = NVL(PCPEDC.TIPOPRIORIDADEENTREGA, 'N'))
         ...
         E.APTO_ID,
          ...
          E.QT_ENDERECADO,
                  ...
                  PCPRODUT.MULTIPLO
        /* ORDER BY NUMPEDRCA,CODFILIALRETIRA,MODULO, RUA, NUMERO, APTO ) --ALTERAÇÃO JEFF 05.12.2018 */       
        /* ORDER BY CODFILIALRETIRA, MODULO, RUA, NUMERO, APTO )        --ALTERAÇÃO JEFF 06.12.2018 */
  /*ALTERAÇÃO JEFF 07.12.2018

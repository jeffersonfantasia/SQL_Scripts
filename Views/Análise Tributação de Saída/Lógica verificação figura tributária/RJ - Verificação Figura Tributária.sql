...
LC_SEMPISCOFINS_ST AS
 (SELECT A.*
    ...
    INNER JOIN VIEW_JC_NCMTABELABASE_RJ B --CONSIDERAR PRODUTOS COM NCM DIF ALIQ
     ...
     AND A.UFDESTINO = B.UFDESTINO
     AND A.CODPROD = B.CODPROD
   INNER JOIN VIEW_JC_ST_SEM_PISCOFINS C --CONSIDERAR PRODUTOS ST ISENTOS DE ICMS E PIS COFINS 04/06
      ON A.CODFILIAL = C.CODFILIAL
     AND A.UFDESTINO = C.UFDESTINO
     AND A.CODPROD = C.CODPROD 
...
LC_NORMAL AS
 (SELECT A.*
   ...
   LEFT JOIN VIEW_JC_ICMS_ST_SEM_PISCOFINS D --DESCONSIDERAR PRODUTOS ISENTOS SOMENTE DE PIS COFINS
     ...
     AND A.UFDESTINO = D.UFDESTINO
     AND A.CODPROD = D.CODPROD   
   WHERE A.CODNCMEX IN ('33049990.1')  /*CONSIDERAR O NCM EM QUESTÃO */ 
     AND A.UFDESTINO = 'RJ'
...
LC_SEMPISCOFINS AS
 (SELECT A.*
   ...
   LEFT JOIN VIEW_JC_NCMTABELABASE_RJ B --DESCONSIDERAR PRODUTOS COM NCM DIF ALIQ
     ...
     AND A.UFDESTINO = B.UFDESTINO
     AND A.CODPROD = B.CODPROD 
    INNER JOIN VIEW_JC_ICMS_ST_SEM_PISCOFINS C --DESCONSIDERAR PRODUTOS ISENTOS SOMENTE DE PIS COFINS
      ON A.CODFILIAL = C.CODFILIAL
     AND A.UFDESTINO = C.UFDESTINO
     AND A.CODPROD = C.CODPROD     
   WHERE A.CODNCMEX IN ('33049990.1')  /*CONSIDERAR O NCM EM QUESTÃO */ 

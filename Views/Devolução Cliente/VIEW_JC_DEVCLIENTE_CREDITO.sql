...
SELECT B.CODFILIAL,
 ...
 WHERE (B.VALOR_ORIG > 0
   ...
   AND NOT( NVL(B.ROTINAESTORNO,'0') LIKE '%1316%' 
    ...
    OR (NVL(B.ROTINAINSERT,'0') LIKE '%ORACLE.EXE%' AND B.ROTINAESTORNO IS NOT NULL)
    OR (NVL(B.ROTINAINSERT,'0') LIKE '%1286%' AND NVL(B.ROTINAESTORNO,'0') LIKE '%619%' AND NVL(B.ROTINABAIXA,'0') LIKE '%619%')
    OR (NVL(B.ROTINAINSERT,'0') LIKE '%1402%' AND NVL(B.ROTINAESTORNO,'0') LIKE '%619%' AND NVL(B.ROTINABAIXA,'0') LIKE '%619%')
    OR (NVL(B.ROTINAINSERT,'0') LIKE '%1303%' AND NVL(B.ROTINAESTORNO,'0') LIKE '%1402%' AND NVL(B.ROTINABAIXA,'0') LIKE '%1402%')
    )

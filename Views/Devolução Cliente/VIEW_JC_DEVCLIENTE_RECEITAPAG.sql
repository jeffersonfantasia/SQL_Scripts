...
SELECT L.CODFILIAL,
 ...
 WHERE L.DTCANCEL IS NULL --RETIRAR REGISTROS CANCELADOS
   ...
   AND (UPPER (L.HISTORICO) NOT LIKE '%SHOW ROOM%' AND
       UPPER (L.HISTORICO) NOT LIKE '%SHOWROOM%' AND
       UPPER (L.HISTORICO) NOT LIKE '%AMOSTRA%' AND
       UPPER (L.HISTORICO) NOT LIKE '%AMOSTRAS%') --RETIRAR OS LANCAMENTOS GERADOS POR RETORNO DE AMOSTRA DE SHOWROOM
;
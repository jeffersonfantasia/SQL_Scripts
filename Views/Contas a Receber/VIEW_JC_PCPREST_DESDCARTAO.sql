...
/*PARA TERMOS A INFORMACAO DO CODCONTAB DOS CARTOES/ MKT NA TABELA PCCLIENT*/ PCCLIENT_CONTABIL AS (
        SELECT B.CODCOB,
               C.CODCONTAB
          FROM PCCOB B
...
/*INFORMACOES DOS CODCLI DOS MARKETPLACES E CARTOES PARA DEPOIS DESCONSIDERARMOS ESSAS DUPLICATAS DESDOBRADAS*/ CLIENTE_MKTPLACE AS (

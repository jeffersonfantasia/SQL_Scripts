CREATE OR REPLACE VIEW VIEW_BI_MOVPROD AS
    SELECT I.DATA,
           ...
           (
               CASE
                   WHEN I.TIPOMOV = 'E' THEN ROUND (((I.QTCONT * I.CUSTOFINEST) + I.VLICMS + I.VLPIS + I.VLCOFINS), 2)
                   ELSE ROUND (((I.QTCONT * I.CUSTOFINEST) + I.VLICMS + I.VLPIS + I.VLCOFINS + I.VLICMSPARTILHA), 2)
               END
           ) AS VLCMV,
           I.VLFRETE,
           I.VLST,

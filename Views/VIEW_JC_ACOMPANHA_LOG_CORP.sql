...
--ATUALIZACAO COM FREQUENCIA DE 5 MIN
START WITH SYSDATE NEXT SYSDATE + 5/1152 AS
  WITH ITENS AS
  ...
  FILIALRETIRA AS 
   (SELECT NUMPED, MAX(I.CODFILIALRETIRA) FILIALRETIRA FROM PCPEDI I GROUP BY NUMPED)
  SELECT P.NUMPED,
         P.DATA,
         (CASE P.CONDVENDA
           WHEN 1 THEN
    ...
    LEFT JOIN JCPRIORIDADESEPARACAO S ON S.NUMPED = P.NUMPED

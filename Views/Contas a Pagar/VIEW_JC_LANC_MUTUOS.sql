...
SELECT B.CODFILIAL,
 ...
 WHERE B.CODBANCO IN (14, 15, 63)
      /*SOMENTE BANCOS DOS MUTUOS E EMPRESTIMOS BANCARIOS*/
   AND NOT ((B.CODBANCO = 14 AND B.CODCONTA = 300102) OR
        (B.CODBANCO = 15 AND B.CODCONTA = 300101) OR
        (B.CODCONTA IN ( 300301, 300302) AND B.CODBANCO = 63) OR
        (B.CODCONTA = 620112 AND B.VPAGO < 0))

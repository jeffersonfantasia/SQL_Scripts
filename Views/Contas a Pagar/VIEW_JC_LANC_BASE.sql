  ...
  SELECT L.CODFILIAL,
   ...
   WHERE NVL(L.INDICE, 0) NOT IN ('B')
     ...
     AND NVL(L.CODCONTA, 0) NOT IN (105, 100022, 100024, 100027)
		 AND NOT (NVL(L.CODCONTA, 0) IN (2104, 2106) AND M.CODBANCO IN ( 80, 104))
     ...
     AND (NVL(C.GRUPOCONTA, 0) NOT IN (680, 900) OR L.CODCONTA = 9005)
        /*NAO CONSIDERAR LANCAMENTOS ORIUNDOS DE VERBAS*/
     AND NOT (L.CODCONTA IN (9004) AND B.CODFILIAL IN (99));
  /

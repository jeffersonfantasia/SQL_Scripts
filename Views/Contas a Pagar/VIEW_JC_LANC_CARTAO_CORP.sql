    ...
    SELECT B.CODFILIAL,
           ...
           (CASE
             ...
             WHEN (B.DTESTORNOBAIXA IS NOT NULL AND B.VPAGO > 0 AND
                  B.CODCONTA IN ( 590101, 4106)) THEN
              'CE'
             ELSE
              'C'
           END) AS TIPO,
     ...
     WHERE B.CODBANCO IN (41)
       ...
       AND ((B.VPAGO < 0 AND B.CODCONTA IN ( 590101, 4106))
           ...
           B.CODCONTA IN ( 590101, 4106)) OR (B.DTESTORNOBAIXA IS NOT NULL AND
           B.VPAGO > 0 AND B.CODCONTA IN ( 590101, 4106)));

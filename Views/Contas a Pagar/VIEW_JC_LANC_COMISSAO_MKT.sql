...
SELECT B.CODFILIAL,
 ...
 WHERE B.CODCONTABCLIENTE IS NOT NULL
   ...
   AND ((B.CODBANCO IN (40, 72, 75) AND B.VPAGO < 0) OR (B.NUMTRANS = 0)
       -- LANCAMENTO DOS IMPOSTOS DAS NOTAS PARA DEDUZIR DO VALOR
       
       OR (B.CODBANCO IN (36, 39) AND B.CODCONTA IN (3201, 410104))
       --LANCAMENTOS DE ASSINATURA DA AMAZON
       
       OR (B.CODBANCO = 11 AND B.CODCONTA IN (3201, 620106)))

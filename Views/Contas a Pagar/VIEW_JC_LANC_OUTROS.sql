...
/*SELECAO DE TODOS OS LANCAMENTOS DE DESCONTOS E JUROS*/ (
  ...
  SELECT B.CODFILIAL,
   ...
   WHERE NOT (B.CODCONTA = 37 AND B.CODROTINABAIXA = 631)
     ...
     AND NOT ((B.CODBANCO = 14 AND B.CODCONTA IN (2403, 300102)) 
        OR (B.CODBANCO = 15 AND B.CODCONTA IN (2402, 300101))
        OR (B.CODBANCO IN (63, 100, 101, 102, 103) AND B.CODCONTA IN ( 2402, 2403, 300301, 300302))
        OR (B.CODCONTA IN ( 4112, 620112) AND B.VPAGO < 0)

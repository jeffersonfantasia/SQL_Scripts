-- =====================================================================
-- PROPOSTA de correcao — JEFFERSON.VIEW_JC_MOVNOTAS_FRETE
-- Escrita em 2026-09-10. NAO APLICADA. Ver views/README.md antes de rodar.
--
-- Unica mudanca: coluna nova TIPOTRANS ('E' = entrada, NUMTRANSACAO e um
-- NUMTRANSENT; 'S' = saida, NUMTRANSACAO e um NUMTRANSVENDA). Sem ela, quem
-- junta por NUMTRANSACAO nao tem como saber de qual numeracao o numero veio —
-- e as duas colidem em 60.062 valores nesta base.
-- Nenhuma linha, filtro ou calculo foi alterado. Diff contra o texto atual da
-- view: 8 linhas acrescentadas, zero removidas.
-- =====================================================================
CREATE OR REPLACE VIEW JEFFERSON.VIEW_JC_MOVNOTAS_FRETE AS
WITH BASEMOVENT AS
   (SELECT M.DTMOV DATA,
           E.CODFILIAL,

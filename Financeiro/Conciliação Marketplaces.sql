...
SELECT P.DTEMISSAO, P.CODFILIAL,
 ...
 INNER JOIN PCNFSAID S ON P.NUMTRANSVENDA = S.NUMTRANSVENDA
  ...
  LEFT JOIN PCPEDCTEMP CT ON W.NUMPEDWEB = CT.NUMPEDWEB
                         AND CT.CODCLI = S.CODCLI
  LEFT JOIN CREDITOS_ABERTOS A ON S.NUMTRANSVENDA = A.NUMTRANSVENDA
 WHERE (P.CODCLI = 563376 OR P.CODCOB IN ('LIVL') OR P.CODUSUR = 119) --AND W.NUMPEDCLI = 'O9919541665603'
  --AND P.DTEMISSAO < '01/08/2025'
      --AND P.DTVENC < TRUNC(SYSDATE) - 1
   AND P.DTPAG IS NULL
--AND P.CODFILIAL = '10'
 ORDER BY P.DTVENC,
...
SELECT P.DTEMISSAO,
 ...
 INNER JOIN PCNFSAID S ON P.NUMTRANSVENDA = S.NUMTRANSVENDA
  ...
  LEFT JOIN PCPEDCTEMP CT ON W.NUMPEDWEB = CT.NUMPEDWEB
                         AND CT.CODCLI = S.CODCLI
  LEFT JOIN CREDITOS_ABERTOS A ON S.NUMTRANSVENDA = A.NUMTRANSVENDA
 WHERE (P.CODCLI = 564395 OR P.CODCOB IN ('SENF') OR P.CODUSUR = 120)
   AND P.DTPAG IS NULL
	 --AND COALESCE(W.NUMPEDCLI, CT.NUMPEDCLI) IN ('1567201425402-01') 
 ORDER BY P.DTVENC,
          P.DUPLIC,
          TO_NUMBER(P.PREST);
...
SELECT P.DTEMISSAO,
 ...
 INNER JOIN PCNFSAID S ON P.NUMTRANSVENDA = S.NUMTRANSVENDA
  ...
  LEFT JOIN PCPEDCTEMP CT ON W.NUMPEDWEB = CT.NUMPEDWEB
                         AND CT.CODCLI = S.CODCLI
  LEFT JOIN CREDITOS_ABERTOS A ON S.NUMTRANSVENDA = A.NUMTRANSVENDA
 WHERE (P.CODCLI = 602599 OR P.CODCOB IN ('CTKT') OR P.CODUSUR = 152)
   AND P.DTPAG IS NULL
	 --AND COALESCE(W.NUMPEDCLI, CT.NUMPEDCLI) = '580733070248937382'
 ORDER BY P.DTVENC,
          P.DUPLIC,
          TO_NUMBER(P.PREST);
...
SELECT P.DTEMISSAO,
 ...
 INNER JOIN PCNFSAID S ON P.NUMTRANSVENDA = S.NUMTRANSVENDA
  ...
  LEFT JOIN PCPEDCTEMP CT ON W.NUMPEDWEB = CT.NUMPEDWEB
                         AND CT.CODCLI = S.CODCLI
  LEFT JOIN CREDITOS_ABERTOS A ON S.NUMTRANSVENDA = A.NUMTRANSVENDA
 WHERE (P.CODCLI = 606140 OR P.CODCOB IN ('COOP', 'SCOB') OR P.CODUSUR = 157)
   AND P.DTPAG IS NULL
	 --AND COALESCE(W.NUMPEDCLI, CT.NUMPEDCLI) IN ('1567201425402-01') 
 ORDER BY P.DTVENC,
          P.DUPLIC,

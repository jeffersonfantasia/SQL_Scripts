--DROP MATERIALIZED VIEW JEFFERSON.MV_JC_PCMOV_SAID;
CREATE MATERIALIZED VIEW MV_JC_PCMOV_SAID
REFRESH FORCE ON DEMAND
START WITH SYSDATE NEXT SYSDATE + 120/1152
AS
    SELECT M.DTMOV,
           M.CODFILIAL,
           M.CODFISCAL,
           ...
           /*VALOR DESCONTO*/
           (CASE
             WHEN M.CODFISCAL = 5927 THEN
              ROUND(M.QTCONT * M.PUNITCONT, 2)
             ELSE
              ROUND(NVL(I.VLCONTABIL, 0), 2)
           END) AS VLTOTALNF,
           /* VALOR BRUTO PRODUTO*/
           ...
           /*PRODUTOS ST*/
             ELSE
              ROUND((NVL(I.VLCONTABIL, 0) - NVL(I.VLBASEICMS, 0)), 2)
           /*PRODUTOS ICMS*/
           END) AS VLOUTRAS_NF,
           /*VALOR TOTAL OUTRAS*/
    ...
    /*TRAZER INFORMACOES COMPLEMENTARES TRIBUTARIAS DOS ITENS*/
      ...
      LEFT JOIN VIEW_JC_CUSTOCONT_TV8 T ON M.NUMTRANSITEM =
                                           T.NUMTRANSITEM_TV8
    ...
    AND M.DTMOV >= TO_DATE('01/01/2023', 'DD/MM/YYYY');
